...
void push_list_llu(ListLlu **list, long long unsigned int value);             /*Inserts at the end*/
void unshift_list_llu(ListLlu **list, long long unsigned int value);          /*Inserts at the beginning*/
void pop_list_llu(ListLlu **list);                                            /*Removes at the end*/
void shift_list_llu(ListLlu **list);                                          /*Removes at the beginning*/
long long unsigned int peek_list_llu(ListLlu *list);                          /*Returns the first value*/
long long unsigned int top_list_llu(ListLlu *list);                           /*Returns the the last value*/
long long int index_of_list_llu(ListLlu *list, long long unsigned int value); /*Returns the index of the first node that contains the value*/
